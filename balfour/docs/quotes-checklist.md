# Balfour Home - Quotes Checklist

Comprehensive tracking for all contractor and supplier quotes.

---

## Prerequisites Before Quoting

- [ ] Material takeoff complete (from takeoff estimator)
- [ ] Cabinet design finalized
- [ ] All TBD selections made (see decisions-todo-checklist.md)
- [ ] Engineering complete (plot plan, retaining walls, septic field)

---

## Labor Quotes - Contractors (33)

### Phase 1: Pre-Construction

| Contractor | Quote Received | Scope Notes |
|------------|----------------|-------------|
| [ ] Engineer | | Plot plan, survey, topo, retaining walls, septic field |
| [ ] Insurance Agent | | Builder's risk policy |
| [ ] Permits | | Building, grading, soil erosion, driveway, septic, well |

### Phase 2: Site Work

| Contractor | Quote Received | Scope Notes |
|------------|----------------|-------------|
| [ ] Silt Fence Contractor | | Install per plot plan |
| [ ] Excavation Contractor - General | | Basement, retaining walls, trenches, French drain |
| [ ] Excavation Contractor - Septic | | Septic system excavation |
| [ ] Well Contractor | | Well drilling, pump, manifold (10-yr warranty) |
| [ ] Grading Contractor - Rough | | Per plot plan spec |
...
| [ ] Masonry Contractor | | Queen-size brick; exterior stone is Affinity Stone (Ridge Cut, Yukon) screw-on panel system quoted separately (material RFQ-72, install RFQ-74) |

### Phase 4: Framing

| Contractor | Quote Received | Scope Notes |
|------------|----------------|-------------|
| [ ] Rough Carpenter (Framing) | | Framing, trusses, deck structure |
...
| Contractor | Quote Received | Scope Notes |
|------------|----------------|-------------|
| [ ] Insulation Contractor | | Batt, blown cellulose, spray foam |
| [ ] Drywall Contractor | | Garage, first floor, basement |
...
| [ ] HVAC Contractor - Finish | | TBD |

### Phase 9: Site Finish

| Contractor | Quote Received | Scope Notes |
|------------|----------------|-------------|
| [ ] Septic Contractor | | Elgin nitrogen reduction system |
| [ ] Grading Contractor - Finish | | Per plot plan spec |
| [ ] Landscaping Contractor | | Topsoil, seed, straw, mulch, fence |
| [ ] Sprinkler Contractor | | Irrigation system |
| [ ] Finish Cleaning Contractor | | Post-construction cleanup |

### Utilities (Coordinate, Not Quote)
...
| Supplier | Quote Received | Scope Notes |
|----------|----------------|-------------|
| [ ] Septic Supplier | | Elgin system components |
| [ ] Well Supplier | | Pump, manifold, pressure tank |
| [ ] Landscaping Supplier | | Topsoil, seed, fertilizer, straw, mulch, fence |
| [ ] Appliance Supplier | | Range, fridge, dishwashers, washer, dryer |

### Rentals

| Supplier | Quote Received | Duration |
|----------|----------------|----------|
| [ ] Dumpster Rental | | 18 months |
| [ ] Port-a-John Rental | | 18 months |

---

## Quote Tracking Summary

| Category | Total | Received | Remaining |
|----------|-------|----------|-----------|
| Pre-Construction | 3 | 0 | 3 |
| Site Work | 5 | 0 | 5 |
| Foundation | 2 | 0 | 2 |
| Framing | 1 | 0 | 1 |
| Dry-In | 4 | 0 | 4 |
| Rough-In | 4 | 0 | 4 |
| Insulation/Drywall | 2 | 0 | 2 |
| Finishes | 10 | 0 | 10 |
| Site Finish | 5 | 0 | 5 |
| **Contractors Total** | **36** | **0** | **36** |
| Structural Materials | 4 | 0 | 4 |
| Exterior Envelope | 5 | 0 | 5 |
| MEP | 7 | 0 | 7 |
| Interior Finishes | 8 | 0 | 8 |
| Site and Other | 4 | 0 | 4 |
| Rentals | 2 | 0 | 2 |
| **Suppliers Total** | **30** | **0** | **30** |
| **GRAND TOTAL** | **66** | **0** | **66** |
