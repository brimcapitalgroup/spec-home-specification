# Balfour Home - Decisions TODO Checklist

All pending decisions, selections, and specifications that need to be completed before construction or quoting.

---

## TBD Items - Decisions Needed
...
| Low Voltage Panel Box Location | Low Voltage | Choose location |

**Note:** Grading scope is per plot plan (already complete) - not a pending decision.
...
## Gaps Identified - Selections NOT Yet Specified
...
| Item | Notes |
|------|-------|
| Door handle brand/finish | No specific selection |
| Bathroom hardware brand/finish | "Match faucet brand" but no faucet selected |

### Trim and Molding

| Item | Notes |
|------|-------|
| Crown molding profile | No specific profile |
| Base molding profile | No specific profile |
| Window casing profile | No specific profile |
| Door casing profile | No specific profile |
| Stair rail/baluster style | Interior and exterior needed |
...
| Washing machine model | Electric specified, no model |
| Dryer model | Gas specified, no model |
...
|----------|-------|
| TBD Decisions | 13 |
| Cabinet Selections | 3 |
| Flooring Selections | 6 |
| Plumbing Fixture Selections | 6 |
